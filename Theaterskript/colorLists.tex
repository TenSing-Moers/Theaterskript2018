...
\addtonumberedlist[textcolors]{white} % Wilma
\addtonumberedlist[textcolors]{white} % Wilhelmina
\addtonumberedlist[textcolors]{white} % Salome
\addtonumberedlist[textcolors]{white} % Cosma
\addtonumberedlist[textcolors]{white} % Wilmas Mutter
\addtonumberedlist[textcolors]{white} % Leon
...
\addtonumberedlist[textcolors]{white} % Aaron
\addtonumberedlist[textcolors]{white} % Cleo
\addtonumberedlist[textcolors]{white} % Theo
\addtonumberedlist[textcolors]{white} % Pikachu
