...
% adds the person to the global list
...
% adds the person to the local list
\NewDocumentCommand{\addpersonlocal}{m}{%
  \seq_gput_right:Nn \l_luke_listofpersons_seq {#1}
%  \edef\sectioncountername{l\thesection}
%  \expandafter\seq_new:N {\l_\sectioncountername}
%  \expandafter\seq_gput_right:Nn {\l_\sectioncountername} {#1}
}

% checks if person is already in the local list
\cs_new:Npn \IfPersonCalledAlreadyF #1#2 {%
  \seq_if_in:NnF \l_luke_listofpersons_seq {#1} {#2}
}

% displays all persons in the local list (at least it should...)
...
%  \edef\currenthighlightcolor{\getnthelement[highlightcolors]{\currentnumber}}
  ...
  \NewPerson{#1}{#2}{#2_highlightcolor}{#2_textcolor}
