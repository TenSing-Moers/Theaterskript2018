...
%\usepackage{pdfrender} % contours, as in https://tex.stackexchange.com/a/387350 (https://tex.stackexchange.com/questions/25221/outlined-characters#387350)
%\usepackage{pst-text} % contours as well, as in https://tex.stackexchange.com/a/25234 (https://tex.stackexchange.com/questions/25221/outlined-characters#25234)
...
% As in https://tex.stackexchange.com/questions/40853/drop-shadow-for-text-in-pgf-beamer#40855
\newcommand\importantstuff[3]{
    ...
    \foreach \x in {-0.1,0.1} {
        \foreach \y in {-0.1,0.1} {         
            \node[black!20] at (#1em+\xoffset em+\x em,#2em+\yoffset em+\y em) {
    ...
    % Main Shadow
    \node[black!40	] at (#1em+0.3em,#2em-0.2em) {
        \scalebox{2}{\Huge\texttt{#3}} 
    };
    \node at (#1em,#2em) {
        \scalebox{2}{\Huge\texttt{#3}} 
