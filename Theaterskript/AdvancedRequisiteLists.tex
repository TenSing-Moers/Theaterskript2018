...
\NewDocumentCommand{\NewRequisite}{m+m+m+m+m}{%
  ...
  \expandafter\NewDocumentCommand\csname #2f\endcsname{+m}{%
    ...
    %}%
    \speechbox{#1}{#3}{#4}{##1}%
  } % defines \<charactername>f-command for printing the full name in
    % the requistie list.
  ...
  } % defines \<charactername>d-command for use of the requisite in text.
