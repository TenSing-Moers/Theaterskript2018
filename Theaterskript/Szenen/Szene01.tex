...
\Scene{Liebes Tagebuch\dots}
\DisplayPersons
\DisplayRequisites
\ort{In Louises Zimmer}
%\requ{Plakat \glqq 1984\grqq}

\StageDir{\milamh sitzt am Bühnenrand, im Hintergrund wird pantomimisch dargestellt, was erzählt wird. Es wird ein \requisite{Plakat}{Plakat 1984} hochgehalten, auf dem \glqq 1984\grqq geschrieben steht.}