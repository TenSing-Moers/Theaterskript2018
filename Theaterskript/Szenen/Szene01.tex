...
\StageDir{\milamh sitzt am Bühnenrand, im Hintergrund wird pantomimisch dargestellt, was erzählt wird. Es wird ein \NewRequisiteAutoColor{Plakat}{plakata}{Plakat} und eine \NewRequisiteAutoColor{Banane}{banane}{Banane} hochgehalten.}
